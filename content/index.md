...
showComments: true
---
# <span class="flex items-center  justify-center "><img src="https://flowershow.youzhidanbairu.eu.org/assets/House.png" alt="House" width="55" height="auto" /><span class="animate-move-bg bg-gradient-to-r from-[#2CD5FFFF] via-[#349CEBFF] to-[#2CD5FFFF] bg-[length:400%] bg-clip-text text-transparent">这里是我的博客主页</span></span>
...
<span class="flex items-center justify-center">
<a href="www.baidu.com" target="_blank"> <img src="https://cdn.jsdelivr.net/gh/baib-web/img/Telegram-icon-on-transparentbackground-PNG.png " class="w-100 mx-100" width="120" height="auto" /> </a>
<span width="200" height="auto"></span>
<a href="www.baidu.com" target="_blank"> <img src="https://cdn.jsdelivr.net/gh/baib-web/img/qq-icon-256x256-gyghvfu1.png " class="w-100 mx-100" width="120" height="auto" /> </a>
</span>
