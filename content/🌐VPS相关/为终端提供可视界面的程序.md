...
>```
## 🌕**mapscii**
![image.png](https://flowershow.youzhidanbairu.eu.org/assets/img/20240801153700.png)
## 🛰️概述
**mapscii**是 OpenStreetMap 的一个有趣的“ASCII 艺术”缩放平移视图。
## 🛰️截图
![QJYI2rF.gif](https://flowershow.youzhidanbairu.eu.org/assets/img/QJYI2rF.gif)
## 🛰️安装
> [!tip] 对于linux
>```Shell
>telnet mapscii.me
...
>```
## 🌕**cmatrix**
![152429qm7vy9e1e1nh1z0h.png](https://flowershow.youzhidanbairu.eu.org/assets/img/152429qm7vy9e1e1nh1z0h.png)
## 🛰️概述
CMatrix 基于黑客帝国网站的屏幕保护程序。它显示文本在终端中飞进飞出，就像电影《黑客帝国》中看到的那样。它可以以相同的速率或异步和用户定义的速度滚动所有行。
## 🛰️截图
![cmatrix-utf8-version-1.gif](https://flowershow.youzhidanbairu.eu.org/assets/img/cmatrix-utf8-version-1.gif)
## 🛰️安装
> [!tip] 对于linux
>```Shell
...
## 🌕**neofetch**
![](https://flowershow.youzhidanbairu.eu.org/assets/img/20240801165114.png)
## 🛰️概述
Neofetch 是一个用 编写的命令行系统信息工具bash 3.2+。Neofetch 以美观且视觉上令人愉悦的方式显示有关您的操作系统、软件和硬件的信息。
## 🛰️截图
![image.png](https://flowershow.youzhidanbairu.eu.org/assets/img/20240801164932.png)

![image.png](https://flowershow.youzhidanbairu.eu.org/assets/img/20240801164836.png)
![image.png](https://flowershow.youzhidanbairu.eu.org/assets/img/20240801164854.png)
## 🛰️安装 
> [!tip] 对于linux
>```Shell
